...
export default function WhiteGoldAluminiumPage() {
  ...
  useEffect(() => {
    ...
    // Prefetch critical assets using traditional DOM approach
    const prefetchAssets = () => {
      // Add preload link for hero image
      const link = document.createElement('link');
      link.rel = 'preload';
      link.as = 'image';
      link.href = '/Desktop2.jpg';
      document.head.appendChild(link);
      
      // Simulate image preloading with timeouts instead of Image constructor
      setTimeout(() => {
        setSectionsVisible(prev => ({ ...prev, products: true }));
      }, 1500);
    };
