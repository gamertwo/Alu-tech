...
const ProjectDetailsModal = ({ isOpen, onClose, project }) => {
  ...
  // Default additional project details
  const additionalDetails = {
    clientName: project.clientName || "Premium Properties Ltd.",
    projectValue: project.projectValue || "$1.2M - $1.5M",
    projectDuration: project.projectDuration || "8 months",
            ...
            {showGallery ? (
              <div className="relative w-full h-[70vh] bg-black">
                ...
                <AnimatePresence mode="wait">
                  ...
                  >
                    <Image
                      src={galleryImages[currentImageIndex]?.src || "/api/placeholder/800/600"}
                      alt={galleryImages[currentImageIndex]?.alt || "Project image"}
                      fill
                ...
                <div className="absolute inset-x-0 bottom-0 p-4 bg-gradient-to-t from-black to-transparent">
                  <p className="text-white text-sm mb-4">
                    {currentImageIndex + 1} / {galleryImages.length} - {galleryImages[currentImageIndex]?.alt || "Project image"}
                  </p>
                  ...
                  <div className="flex justify-between items-center">
                    ...
                    {/* Thumbnail strip */}
                    <div className="flex gap-2 overflow-x-auto max-w-lg mx-auto p-1 scrollbar-hide">
              ...
              <div className="flex flex-col md:flex-row w-full">
                ...
                <div className="md:w-3/5 p-6 overflow-y-auto max-h-[90vh] md:max-h-[80vh]">
                  ...
                  <p className="text-gray-600 mb-6">{project.description || "No description available."}</p>

                  {/* Project Info */}
                  <div className="flex flex-wrap gap-4 mb-6 bg-sky-50 p-4 rounded-lg">
                    <div className="flex items-center text-sm text-gray-700">
                      <Building className="h-4 w-4 mr-2 text-sky-600" />
                      <span><strong>Location:</strong> {project.location || "Various Locations"}</span>
                    </div>
                    <div className="flex items-center text-sm text-gray-700">
                      <Calendar className="h-4 w-4 mr-2 text-sky-600" />
                      <span><strong>Completed:</strong> {project.completionDate || "Ongoing"}</span>
                    </div>
                    <div className="flex items-center text-sm text-gray-700">
